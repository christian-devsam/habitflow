        ...
        {view !== 'reset' && (
          <>
            ...
            <div className="space-y-2.5 mb-5">
              ...
              <button
                onPointerDown={e => e.preventDefault()}
                onPointerUp={() => handleOAuth('github')}
                disabled={!!oauthLoading || loading}
                className="w-full flex items-center justify-center gap-3 py-3.5 rounded-2xl bg-[#24292e] text-white font-semibold text-sm hover:bg-[#2f363d] active:scale-[0.98] disabled:opacity-50 transition-all"
              >
                {oauthLoading === 'github'
